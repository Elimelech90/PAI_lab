...
image_path = r"X-X-Everywhere.jpg"
...
image = cv2.imread(r"X-X-Everywhere.jpg")
...
img_weighted = cv2.imread(r"X-X-Everywhere.jpg")
...
import cv2
import matplotlib.pyplot as plt
img = cv2.imread(r"X-X-Everywhere.jpg")
...
import numpy as np
import matplotlib.pyplot as plt
img = cv2.imread(r"X-X-Everywhere.jpg", 0)  
...
import cv2
src = cv2.imread(r"X-X-Everywhere.jpg")  # Read the image
...
import cv2
src = cv2.imread(r"X-X-Everywhere.jpg")
